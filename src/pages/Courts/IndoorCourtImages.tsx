...
export const IndoorCourtImages: React.FC = () => {
      ...
      const mockImages: CourtImage[] = [
        {
          id: '1',
          courtId: courtId!,
          url: 'https://images.pexels.com/photos/863988/pexels-photo-863988.jpeg?auto=compress&cs=tinysrgb&w=400',
          filename: 'indoor-court1.jpg',
          size: 1024000,
        ...
        },
        {
          id: '2',
          courtId: courtId!,
          url: 'https://images.pexels.com/photos/1263349/pexels-photo-1263349.jpeg?auto=compress&cs=tinysrgb&w=400',
          filename: 'indoor-court2.jpg',
          size: 2048000,
          ...
          <Col>
            <Space>
              <Button
                ...
                onClick={() => navigate('/indoor-courts')}
              >
                返回
              </Button>
      ...
      <Card title="上传图片" className="mb-4">
        ...
        <Space>
          ...
          <Button
            ...
            onClick={() => navigate(`/indoor-courts/${courtId}/bulk-upload-images`)}
          >
            批量上传图片
          </Button>
        </Space>
